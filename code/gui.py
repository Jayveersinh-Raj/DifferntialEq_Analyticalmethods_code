...
class MainWindow(QDialog):
    ...
    def update_plots(self):
        ...
        colors = {
            ...
            'improved_euler': pg.mkPen((255, 165, 0), width=4),
        ...
        x_improved_euler, y_improved_euler, lte_improved_euler, gte_improved_euler = ImprovedEuler.apply(self.params)
        x_runge, y_runge, lte_runge, gte_runge = Runge.apply(self.params)

        # Calculate worst GTE
        euler_worst_errors = []
        improved_euler_worst_errors = []
        runge_worst_errors = []
        ...
        for n in step_sizes:
            ...
            _, _, _, gte_improved_euler = ImprovedEuler.apply(tmp_values)
            _, _, _, gte_runge = Runge.apply(tmp_values)

            euler_worst_errors.append(max(gte_euler))
            improved_euler_worst_errors.append(max(gte_improved_euler))
        ...
        self.graph_plots.plot(x_improved_euler, y_improved_euler, pen=colors['improved_euler'], name="Improved "
                                                                                                     "Euler's method")
        ...
        self.lte_plots.plot(x_improved_euler, lte_improved_euler, pen=colors['improved_euler'], name="Improved "
                                                                                                     "Euler's method")
        ...
        self.gte_plots.plot(step_sizes, improved_euler_worst_errors, pen=colors['improved_euler'], name="Improved "
                                                                                                        "Euler's "
                                                                                                        "method")
