...
class NumericalMethod:
    ...
    It will be inherited by inherited by 'Euler', 'Improved Euler's', 'Runge' classes,
    ...
    def y(cls, x, x0, y0):
        ...
        """
        return np.exp((-3/x)+np.log(y0)+(3/x0)-2*np.log(x0))*x*x
    ...
    def method(cls, x: float, y: float, h: float):
        ...
        as the Euler's method or Improved Euler's method.
